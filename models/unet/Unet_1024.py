...
def train_and_predict():
    ...
    callbacks = [tf.keras.callbacks.ModelCheckpoint('weights.h5', monitor='val_loss', save_best_only=True),
                 tf.keras.callbacks.EarlyStopping(monitor='val_dice_coef', patience=20, min_delta=0, mode='max'),
    ...
    history = model.fit(imgs_train, imgs_mask_train, batch_size=8, epochs=80, verbose=1, shuffle=False,
